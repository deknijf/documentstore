...
class Document(Base):
    ...
    preprocessed_file_path: Mapped[str | None] = mapped_column(String(500), nullable=True)
    preprocessed_content_type: Mapped[str | None] = mapped_column(String(128), nullable=True)
...
class ExtractionHint(Base):
    ...
    hint_kind: Mapped[str] = mapped_column(String(32), nullable=False, default="manual_correction")
